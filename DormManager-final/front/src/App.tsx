...
import { AffecterChambrePage } from './components/pages/AffecterChambrePage';
import { VoirDemandePage } from './components/pages/VoirDemandePage';
import { AjouterChambrePage } from './components/pages/AjouterChambrePage';
import { UserFormulePage } from './components/pages/UserFormulePage';
import { ChambreFormulePage } from './components/pages/ChambreFormulePage';
import { EnSavoirPlusPage } from './components/pages/EnSavoirPlusPage';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {currentPage === 'affecter-chambre' && <AffecterChambrePage navigate={navigate} onLogout={handleLogout} />}
      {currentPage === 'voir-demande' && <VoirDemandePage navigate={navigate} onLogout={handleLogout} />}
      {currentPage === 'ajouter-chambre' && <AjouterChambrePage navigate={navigate} onLogout={handleLogout} />}
      {currentPage === 'create-user' && <CreateUserPage navigate={navigate} />}
      {currentPage === 'user-formula' && <UserFormulePage navigate={navigate} onLogout={handleLogout} />}
      {currentPage === 'chambre-formula' && <ChambreFormulePage navigate={navigate} onLogout={handleLogout} />}
      {currentPage === 'en-savoir-plus' && <EnSavoirPlusPage navigate={navigate} />}
    </div>
